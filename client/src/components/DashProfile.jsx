    ...
    const handleImageChange = (e) => {
       ...
       const handleSubmit = async (e) =>{
            ...
            if(imageFileUploading){
                setUpdateUserError('Please wait while uploading the profile picture');
                return;
            }
            try {
    ...
    return (
        (<div className='max-w-lg mx-auto p-3 w-full'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                ...
                <TextInput type='text' id='username' placeholder='email' defaultValue={currentUser.email} onChange={handleChange}/>
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)} popup size='md'>
                ...
                <Modal.Body>
                    <div className="text-center">
                        ...
                        <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Are you sure want to delete Account</h3>
                    </div>
